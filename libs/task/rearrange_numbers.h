#ifndef UNTITLED6_REARRANGE_NUMBERS_H
#define UNTITLED6_REARRANGE_NUMBERS_H
...
void test_rearrange_numbers_1_empty_file() {
    const char filename[] = "C:\\Users\\zevss\\CLionProjects\\lab\\tasks_tests\\task_7_test_1.txt";
    FILE* file = fopen(filename, "wb");
    fclose(file);
...
void test_rearrange_numbers_2_only_negative_numbers() {
    const char filename[] = "C:\\Users\\zevss\\CLionProjects\\lab\\tasks_tests\\task_7_test_2.txt";;
...
void test_rearrange_numbers_3_only_positive_numbers() {
    const char filename[] = "C:\\Users\\zevss\\CLionProjects\\lab\\tasks_tests\\task_7_test_3.txt";;
...
void test_rearrange_numbers_4_mixed_numbers() {
    const char filename[] = "C:\\Users\\zevss\\CLionProjects\\lab\\tasks_tests\\task_7_test_4.txt";;
...
#endif //UNTITLED6_REARRANGE_NUMBERS_H
