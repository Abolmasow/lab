#ifndef UNTITLED6_CONVERT_FLOAT_NUM_H
#define UNTITLED6_CONVERT_FLOAT_NUM_H
...
void convert_float(const char* filename) {
    ...
    vectorVoid v = createVectorVoid(0, sizeof(float));
...
void test_convert_float_1_zero_quantity() {
    const char filename[] = "C:\\Users\\zevss\\CLionProjects\\lab_work_19\\tasks_tests\\task_2_test_1.txt";
...
void test_convert_float_2_one_element() {
    const char filename[] = "C:\\Users\\zevss\\CLionProjects\\lab_work_19\\tasks_tests\\task_2_test_2.txt";
...
void test_convert_float_3_more_element() {
    const char filename[] = "C:\\Users\\zevss\\CLionProjects\\lab_work_19\\tasks_tests\\task_2_test_3.txt";
...
#endif //UNTITLED6_CONVERT_FLOAT_NUM_H
