#ifndef UNTITLED6_REMOVE_POLYNOMIAL_H
#define UNTITLED6_REMOVE_POLYNOMIAL_H
...
void remove_true_polynomial(const char* filename, double x) {
    vectorVoid v = createVectorVoid(16, sizeof(monomial));
    ...
    monomial m;
    vectorVoid temp = createVectorVoid(8, sizeof(monomial));
    double result = 0;
...
void test_remove_true_polynomial_1_empty_file() {
    const char filename[] = "C:\\Users\\zevss\\CLionProjects\\lab\\tasks_tests\\task_6_test_1.txt";
...
void test_remove_true_polynomial_2_not_true_expression() {
    const char filename[] = "C:\\Users\\zevss\\CLionProjects\\lab\\tasks_tests\\task_6_test_2.txt";
...
void test_remove_true_polynomial_3_true_expression() {
    const char filename[] = "C:\\Users\\zevss\\CLionProjects\\lab\\tasks_tests\\task_6_test_3.txt";
...
#endif //UNTITLED6_REMOVE_POLYNOMIAL_H
